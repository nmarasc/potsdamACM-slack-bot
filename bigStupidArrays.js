exports.emotes = [
  ...
  ":sweat_drops:",
  ":eggplant:",
  ":fire: :fire: :100: :ok_hand:",
  ":spin2win:",
  ":greg_v2:"];

exports.eightball_msg = [
  "It is certain",
  "It is decidedly so",
  "Without a doubt",
  "Yes, definitely",
...
"Change can hurt, but it leads down a path to something better.",
...
"Life does not consist of holding good cards, but of playing those you hold well.",
...
"A man is born to live, not prepared to live.",
...
"The person who appears most wrong, is also quite often right.",
...
"Your true love will show theirself to you under the moonlight.",
...
"The most useless effort is trying to change what and whom God so carefully created.",
"Do not be covered in sadness or be fooled by happiness they both must exist.",
...
"Success is the sum of your unique visions realized by the sweat of perseverance.",
"When you expect your opponent to yield, you should avoid hurting him.",
...
"Hold on to the past, but eventually let the times go and keep the memories in the present.",
...
"One always regrets what they could have done. Remember for next time.",
...
"In music, one must think with their heart and feel with their brain.",
...
"Simplicity and clarity should be the theme of your dress.",
"The virtuous find joy while wrongdoers find grief in their actions.",
"Bread today is better than cake tomorrow.",
"In everything there is a piece of truth. But only a piece.",
...
"I do and I understand.I have a dream....Time to go to bed.",
